update biz_data_pipeline_processor_instructions set content = '
...
- 表达式：(?: 表达式1|表达式2) (?: ⧵"(?<upstreamTime>(\\[^⧵"\\]+))⧵"|)
- 含义：解析“”中有没有值，有的话value匹配upstreamTime字段，没有的话就不作处理；

#### 2）一个大字段中有包含两个小字段

- 表达式：(?<cookie>((?<jsessionid>(\\[^⧵⧵?\\]+))⧵⧵? (?<JSESSIONID>\\[^ \\]+))))
...
注：当字段名内含有“.”时，会识别为层级结构，如不想识别为层级结构，需要在“.”前加转义符为 “\\\\\\\\.”', content_en = '
...
"info":"service:com.abc.open.nlp.facade.NLPService"}
```
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =7;
update biz_data_pipeline_processor_instructions set content = '
...
"_cw_raw_time":1605773216758}
```
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =9;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =11;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =12;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =13;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =15;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =16;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =17;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =18;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =19;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =20;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =21;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =22;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =23;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =24;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =25;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =27;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =28;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =29;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =30;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =31;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =32;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =33;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =34;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =35;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =36;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =37;
update biz_data_pipeline_processor_instructions set content = '
...
Note: If a field name contains a period (.), the field is identified as a hierarchical structure. To prevent this, you must add an escape character (“\\\\\\\\”) before the period (.).' where id =38;
INSERT INTO  `biz_data_pipeline_processor_instructions`(`id`, `type`, `content`, `content_en`, `is_deleted`, `modified_user_id`, `modified_time`, `creation_user_id`, `creation_time`) VALUES (39, 'extractField', '#### 组件说明：

提取一个或多个字段，多个字段用逗号隔开，结果只保存提取出的字段，重复字段默认只保留第一个，提取结果按照填写顺序提取。
...
```js
{"aaa":{"v1":33,"v2":44},"bbb":444,"ccc":555}
```

#### 配置信息：

```js
{"fieldList":"ccc,aaa.v2"}
```
...
```js
{
  "_cw_collect_time": 1624260702666,
  "_cw_raw_time": 1624260702666,
  "ccc": 555,
  "aaa": {
    "v2": 44
  }
...
注：当字段名内含有“.”时，会识别为层级结构，如不想识别为层级结构，需要在“.”前加转义符为 “\\\\\\\\.”', '#### Component description:

The component used to extract one or more fields. Separate multiple fields with commas (,). Only the extracted fields are saved. For duplicated fields, only the first field is saved.

#### Field description:

fieldList：Extract field list.
